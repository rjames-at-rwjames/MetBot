...
picdir=cwd+"/../../../CTdata/test_metbot/"
ys="1974_2013" # edit for longer file
...
if noaaolr:
    ...
    print dsrc+'olr.day.mean.'+ys+'.nc'
    olr,time,lat,lon,dtime = mync.openolr(dsrc+'olr.day.mean.'+ys+'.nc','olr',subs=sub)
    if ys=='1979_1979':
