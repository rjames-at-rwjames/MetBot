...
'noaa-olr-0-full': {'area': (5000, 1000000), 'angle': False, 
                    ...
                    'thresh': (230,'low'), 'text': "Cloudband" },
'ncdr-olr-0-0': {'area': (4, 3000), 'angle': (-90., -5.0), 'latextent': (-20, -40), 'ROI': (0, 360, -15, -40),
                 'angleROI': (0, 360, -23, -33), 'stretch': (100, 320), 'thresh': (240, 'low'),
                 'text': "Cloudband"},
'ncdr-olr-0-all': {'area': (4, 3000), 'angle': False, 'latextent': False, 'ROI': (0, 360, -15, -40),
                   'stretch': (100, 320), 'thresh': (240, 'low'), 'text': "Cloudband"},
'ncdr-olr-0-full': {'area': (4, 3000), 'angle': False, 'latextent': False, 'ROI': False, 'stretch': (100, 320),
                    'thresh': (240, 'low'), 'text': "Cloudband"}}
