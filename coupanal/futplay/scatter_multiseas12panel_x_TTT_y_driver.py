# To create a 12 panel figure of scatter plots
            ...
            if thcnt > 0:
                ...
                for cent in range(len(cents)):
                    ...
                    for s in range(len(seas)):
                        ...
                        # Find location in 12 plots where this one goes
                        loc4arr=s+nmons
                ...
                print 'Now we have calculated everything for 2 timeperiods and 12 seasons, calc change'
                ...
                print 'Loop 12 seasons and plot'
                for pt in range(nplot):
