...
import group_dict_inmcm_shift as dset_grp
...
figdir=botdir+"/revplay/qfluxmaps_groupcomp/"
my.mkdir_p(figdir)
...
ns_groups = [1,7,8,3,5,3] # number in each group - 6 for purple because missing data for HadGEM2-ES
